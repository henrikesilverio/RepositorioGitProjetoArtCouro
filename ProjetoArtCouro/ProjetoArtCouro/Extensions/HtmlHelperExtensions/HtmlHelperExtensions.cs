...
namespace ProjetoArtCouro.Web.Extensions.HtmlHelperExtensions
{
    public static class HtmlHelperExtensions
    {
        public static HtmlString ValidationSummaryBootstrap(this HtmlHelper htmlHelper)
        {
            ...
            var listMessegeErros = listErro.Errors.Aggregate("", (current, erro) => current + ("<div class=\"alert alert-warning fade in\">" + "<button class=\"close\" data-dismiss=\"alert\">×</button>" + "<i class=\"fa-fw fa fa-warning\"></i>" + "<strong>Atenção </strong>" + erro.ErrorMessage + "</div>"));
